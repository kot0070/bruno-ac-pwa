...
return {collectBrunoStorage:collectBrunoStorage,buildBackup:buildBackup,validateJournalRaw:validateJournalRaw,validateBackup:validateBackup,restoreBackup:restoreBackup,init:init};
});
