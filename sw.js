...
const SHELL = [
  ...
  './service-journal-ux.js','./app-backup-bridge.js','./project-mode-bridge.js','./project-estimator-core.js','./project-history-core.js','./project-estimator-wizard.js','./project-estimator-wizard.css','./project-building-schema.js','./project-building-ux.js','./project-load-engine.js','./project-load-ux.js',
