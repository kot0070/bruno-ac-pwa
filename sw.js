...
const SHELL = [
  ...
  './service-journal-ux.js','./app-backup-bridge.js','./project-mode-bridge.js','./project-estimator-core.js','./project-history-core.js','./project-estimator-wizard.js','./project-estimator-wizard.css','./project-building-schema.js','./project-building-ux.js','./project-load-engine.js','./project-load-ux.js','./project-equipment-engine.js','./project-equipment-ux.js','./project-electrical-engine.js','./project-electrical-ux.js','./project-mechanical-bom-engine.js','./project-mechanical-bom-ux.js','./project-catalog-pricing-engine.js','./project-catalog-pricing-ux.js','./project-compliance-gate.js','./project-compliance-ux.js',
