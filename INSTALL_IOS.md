# Install Bruno AC Estimating on iPhone

Bruno AC Estimating is a Progressive Web App (PWA). On iPhone it installs from Safari and runs like an app from the Home Screen.
...
1. Open **https://kot0070.github.io/bruno-ac-pwa/** in **Safari**.
2. Tap the **Share** button (square with an upward arrow).
3. Scroll and tap **Add to Home Screen**.
4. Confirm the name (**Bruno AC**) and tap **Add**.
...
- This app does **not** share data with Bruno Electric Estimating (`bruno-ac-*` vs `bruno-electric-*` keys).
