...
function load(building,extra){building=building||{};extra=extra||{};var p=building.project||{},e=building.envelope||{},design=e.design||{},wall=e.wall||{},roof=e.roof||{},floor=e.floor||{},win=e.windows||{},doors=e.doors||{},inf=e.infiltration||{},vent=e.ventilation||{},g=e.internalGains||{},zones=Array.isArray(building.zones)?building.zones:[];
 ...
 if(missing.length)return {calculation_method:METHOD,input_completeness:'blocked',missing:missing,sources:['RESIDENTIAL_LOAD_MANUAL_J_01','COMMERCIAL_LOAD_AUSTIN_IECC_C403_2_1'],cooling_sensible_Btuh:null,cooling_latent_Btuh:null,cooling_total_Btuh:null,heating_Btuh:null,design_supply_airflow_CFM:null,zone_loads:[],notes:notes};
 var dCool=Math.max(0,outCool-inCool),dHeat=Math.max(0,inHeat-outHeat),opaqueWall=Math.max(0,wallArea-winArea-doorArea);
